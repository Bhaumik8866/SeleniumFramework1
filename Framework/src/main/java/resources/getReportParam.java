...
public class getReportParam {
	...
	public getReportParam(WebDriver driver2) {
		this.driver=driver2;
	}
...
//					a.add(r.getCell(column).getStringCellValue());
	...
	public static void main(String[] args) throws IOException {
		...
		getReportParam d=new getReportParam(driver);
		ArrayList<String> data= d.getdata("Annotations");
		...
		System.out.println("Paramerters required with this report are;");
