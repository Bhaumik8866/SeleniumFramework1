...
public class annotation extends initializeDriver{
	public static Logger log=LogManager.getLogger(initializeDriver.class.getName());
	public WebDriver driver;
	@Test
	public void annotationSection() throws IOException
	{
		driver=driverinit();
		...
		hem.annotation().sendKeys(Keys.CONTROL,Keys.ENTER);
		log.info("annotaion page opened");
